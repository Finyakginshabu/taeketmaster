...
import React, { Component, cloneElement, createElement, createRef, useCallback, useEffect, useLayoutEffect, useRef } from "react";
...
var useSafeInsertionEffect = { ...React$1 }.useInsertionEffect || ((fn) => fn());
...
var InputTime = function(_super) {
	...
	function InputTime(props) {
		...
		_this.renderTimeInput = function() {
			...
			if (customTimeInput) return cloneElement(customTimeInput, {
				date,
				value: time,
...
var Day = function(_super) {
	...
	function Day() {
		...
		_this.render = function() {
			...
			}, _this.renderDayContents(), _this.getTitle() !== "" && React.createElement("span", { className: "overlay" }, _this.getTitle()));
		};
		return _this;
	}
	...
	function Week() {
		...
		_this.renderDays = function() {
			...
			if (_this.props.showWeekNumber) {
				...
				days.push(React.createElement(WeekNumber, _assign({ key: "W" }, Week.defaultProps, _this.props, {
					weekNumber,
			...
			return days.concat([
				...
				return React.createElement(Day, _assign({}, Week.defaultProps, _this.props, {
...
var Month = function(_super) {
	...
	function Month() {
		...
		_this.renderWeeks = function() {
			...
			while (true) {
				weeks.push(React.createElement(Week, _assign({}, _this.props, {
		...
		_this.renderQuarters = function() {
			...
			return React.createElement("div", { className: "react-datepicker__quarter-wrapper" }, [
				1,
				2,
				3,
				4
	...
	Month.prototype.render = function() {
		...
		if (showMonthYearPicker || showQuarterYearPicker) return React.createElement("div", {
		...
		return React.createElement("div", { role: "table" }, this.props.dayNamesHeader && React.createElement("div", { role: "rowgroup" }, this.props.dayNamesHeader), this.props.monthHeader && React.createElement("div", { role: "rowgroup" }, this.props.monthHeader), React.createElement("div", {
			className: this.getClassNames(),
			onMouseLeave: !this.props.usePointerEvent ? this.handleMouseLeave : void 0,
			onPointerLeave: this.props.usePointerEvent ? this.handleMouseLeave : void 0,
			"aria-label": formattedAriaLabel,
			role: "rowgroup"
		}, this.renderWeeks()), this.props.monthFooter && React.createElement("div", { role: "rowgroup" }, this.props.monthFooter));
	};
	return Month;
}(Component);
var MonthDropdownOptions = function(_super) {
	...
	function MonthDropdownOptions() {
		...
		_this.renderOptions = function() {
			...
			return _this.props.monthNames.map(function(month, i) {
				...
				}, _this.isSelectedMonth(i) ? React.createElement("span", { className: "react-datepicker__month-option--selected" }, "✓") : "", month);
			});
		};
	...
	MonthDropdownOptions.prototype.render = function() {
		return React.createElement(ClickOutsideWrapper, {
...
var MonthDropdown = function(_super) {
	...
	function MonthDropdown() {
		...
		_this.renderReadView = function(visible, monthNames) {
			...
			}, React.createElement("span", { className: "react-datepicker__month-read-view--down-arrow" }), React.createElement("span", { className: "react-datepicker__month-read-view--selected-month" }, monthNames[_this.props.month]));
		};
		_this.renderDropdown = function(monthNames) {
			return React.createElement(MonthDropdownOptions, _assign({ key: "dropdown" }, _this.props, {
				monthNames,
	...
	function MonthYearDropdownOptions(props) {
		...
		_this.renderOptions = function() {
			return _this.state.monthYearsList.map(function(monthYear) {
				...
				}, isSameMonthYear ? React.createElement("span", { className: "react-datepicker__month-year-option--selected" }, "✓") : "", formatDate(monthYear, _this.props.dateFormat, _this.props.locale));
			});
		};
	...
	function MonthYearDropdown() {
		...
		_this.renderReadView = function(visible) {
			...
			return React.createElement("div", {
				...
				onClick: _this.toggleDropdown
			}, React.createElement("span", { className: "react-datepicker__month-year-read-view--down-arrow" }), React.createElement("span", { className: "react-datepicker__month-year-read-view--selected-month-year" }, yearMonth));
		};
		_this.renderDropdown = function() {
			return React.createElement(MonthYearDropdownOptions, _assign({ key: "dropdown" }, _this.props, {
				onChange: _this.onChange,
				onCancel: _this.toggleDropdown
			}));
		};
...
var Time = function(_super) {
	...
	function Time() {
		...
		_this.renderTimeCaption = function() {
			if (_this.props.showTimeCaption === false) return React.createElement(React.Fragment, null);
			return React.createElement("div", {
	...
	Time.prototype.render = function() {
		...
		return React.createElement("div", { className: "react-datepicker__time-container ".concat(((_a = this.props.todayButton) !== null && _a !== void 0 ? _a : Time.defaultProps.todayButton) ? "react-datepicker__time-container--with-today-button" : "") }, this.renderTimeCaption(), React.createElement("div", { className: "react-datepicker__time" }, React.createElement("div", { className: "react-datepicker__time-box" }, React.createElement("ul", {
...
var Year = function(_super) {
	...
	Year.prototype.render = function() {
		...
		var _loop_1 = function(y) {
			yearsList.push(React.createElement("div", {
		...
		return React.createElement("div", { className: "react-datepicker__year" }, React.createElement("div", {
	...
	function YearDropdownOptions(props) {
		...
		_this.renderOptions = function() {
			...
			var options = _this.state.yearsList.map(function(year) {
				...
				}, selectedYear === year ? React.createElement("span", { className: "react-datepicker__year-option--selected" }, "✓") : "", year);
			});
...
var YearDropdown = function(_super) {
	...
	function YearDropdown() {
		...
		_this.renderSelectOptions = function() {
			...
			var options = [];
			for (var i = minYear; i <= maxYear; i++) options.push(React.createElement("option", {
				key: i,
				value: i
			}, i));
			return options;
		...
		_this.renderReadView = function(visible) {
			return React.createElement("button", {
				...
				onClick: _this.toggleDropdown
			}, React.createElement("span", { className: "react-datepicker__year-read-view--down-arrow" }), React.createElement("span", { className: "react-datepicker__year-read-view--selected-year" }, _this.props.year));
		};
		_this.renderDropdown = function() {
			return React.createElement(YearDropdownOptions, _assign({ key: "dropdown" }, _this.props, {
				onChange: _this.onChange,
				onCancel: _this.toggleDropdown
			}));
		};
...
var Calendar = function(_super) {
	...
	function Calendar(props) {
		...
		_this.header = function(date, customDayNameCount) {
			...
			var dayNames = [];
			if (_this.props.showWeekNumbers) dayNames.push(React.createElement("div", {
				key: "W",
				className: "react-datepicker__day-name ".concat(disabled ? "react-datepicker__day-name--disabled" : ""),
				role: "columnheader"
			}, React.createElement("span", { className: "react-datepicker__sr-only" }, "Week number"), React.createElement("span", { "aria-hidden": "true" }, _this.props.weekLabel || "#")));
			return dayNames.concat([
				...
				return React.createElement("div", {
					...
					role: "columnheader",
					className: clsx("react-datepicker__day-name", weekDayClassName, disabled ? "react-datepicker__day-name--disabled" : "")
				}, React.createElement("span", { className: "react-datepicker__sr-only" }, fullDayName), React.createElement("span", { "aria-hidden": "true" }, weekDayName));
			}));
		};
		...
		_this.renderYearDropdown = function(overrideHide) {
			...
			return React.createElement(YearDropdown, _assign({}, Calendar.defaultProps, _this.props, {
		...
		_this.renderMonthDropdown = function(overrideHide) {
			...
			return React.createElement(MonthDropdown, _assign({}, Calendar.defaultProps, _this.props, {
		...
		_this.renderMonthYearDropdown = function(overrideHide) {
			...
			return React.createElement(MonthYearDropdown, _assign({}, Calendar.defaultProps, _this.props, {
				date: _this.state.date,
		...
		_this.renderDefaultHeader = function(_a) {
			...
			return React.createElement("div", { className: "react-datepicker__header-wrapper" }, _this.renderPreviousButton() || null, _this.renderNextButton() || null, headerContent);
		};
		...
		_this.renderMonths = function() {
			...
			for (var i = 0; i < monthsShown; ++i) {
				...
				monthList.push(React.createElement("div", {
					...
					monthDate,
					i
				}), React.createElement(Month, _assign({}, Calendar.defaultProps, _this.props, {
		...
		_this.renderYears = function() {
			...
			if (_this.props.showYearPicker) return React.createElement("div", { className: "react-datepicker__year--container" }, _this.renderHeader({ monthDate: _this.state.date }), React.createElement(Year, _assign({}, Calendar.defaultProps, _this.props, {
				selectingDate: _this.state.selectingDate,
				date: _this.state.date,
				onDayClick: _this.handleDayClick,
		...
		_this.renderTimeSection = function() {
			if (_this.props.showTimeSelect && (_this.state.monthContainer || _this.props.showTimeSelectOnly)) return React.createElement(Time, _assign({}, Calendar.defaultProps, _this.props, {
		...
		_this.renderInputTimeSection = function() {
			...
			if (_this.props.selectsRange) {
				...
				return React.createElement(React.Fragment, null, React.createElement(InputTime, _assign({}, Calendar.defaultProps, _this.props, {
					date: startTime,
				...
				})), React.createElement(InputTime, _assign({}, Calendar.defaultProps, _this.props, {
					date: endTime,
			...
			return React.createElement(InputTime, _assign({}, Calendar.defaultProps, _this.props, {
				date: time,
				timeString,
				onChange: function(time) {
					var _a, _b;
		...
		_this.renderAriaLiveRegion = function() {
			var _a;
			if (!isValid(_this.state.date)) return React.createElement("span", {
				role: "alert",
				"aria-live": "polite",
		...
		_this.renderChildren = function() {
			if (_this.props.children) return React.createElement("div", { className: "react-datepicker__children-container" }, _this.props.children);
		};
...
var CalendarIcon = function(_a) {
	...
	if (typeof icon === "string") return React.createElement("i", {
...
var PopperComponent$1 = function(props) {
	...
	if (!hidePopper) {
		...
		popper = React.createElement(TabLoop, { enableTabLoop }, React.createElement("div", {
			ref: popperProps.refs.setFloating,
			style: popperProps.floatingStyles,
			className: classes,
			"data-placement": popperProps.placement,
			onKeyDown: popperOnKeyDown
		}, popperComponent, showArrow && React.createElement(FloatingArrow, {
	...
	if (props.popperContainer) popper = createElement(props.popperContainer, {}, popper);
	if (portalId && !hidePopper) popper = React.createElement(Portal, {
		portalId,
		portalHost
	}, popper);
...
var DatePicker = function(_super) {
	...
	function DatePicker(props) {
		...
		_this.renderCalendar = function() {
			...
			return React.createElement(Calendar, _assign({
		...
		_this.renderClearButton = function() {
			...
			if (isClearable && !readOnly && (selected != null || startDate != null || endDate != null || (selectedDates === null || selectedDates === void 0 ? void 0 : selectedDates.length))) return React.createElement("button", {
				type: "button",
	...
	DatePicker.prototype.renderInputContainer = function() {
		...
		return React.createElement("div", { className: "react-datepicker__input-container".concat(showIcon ? " react-datepicker__view-calendar-icon" : "") }, showIcon && React.createElement(CalendarIcon, _assign({
			icon,
	...
	DatePicker.prototype.render = function() {
		...
		if (this.props.withPortal) {
			var portalContainer = this.state.open ? React.createElement(TabLoop, { enableTabLoop: this.props.enableTabLoop }, React.createElement("div", {
				className: "react-datepicker__portal",
				tabIndex: -1,
				onKeyDown: this.onPortalKeyDown
			}, calendar)) : null;
			if (this.state.open && this.props.portalId) portalContainer = React.createElement(Portal, _assign({ portalId: this.props.portalId }, this.props), portalContainer);
			return React.createElement(React.Fragment, null, this.renderInputContainer(), portalContainer);
		}
		return React.createElement(PopperComponent, _assign({}, this.props, {
