...
const resetPasswordSchema = z.object({
  ...
  path: ["confirmPassword"], // ให้ Error ไปโชว์ที่ช่องยืนยันรหัส
});
...
export default function ResetPasswordPage() {
  ...
  const onSubmit = (data) => {
    ...
    // TODO: จุดที่เพื่อน Backend จะมาต่อ API เพื่อเปลี่ยนรหัสใน Database
    
    // จำลองว่าเปลี่ยนสำเร็จ แจ้งเตือน และเด้งกลับไปหน้า Login
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="auth-field">
            ...
            <div style={{ position: 'relative', width: '100%' }}>
              ...
              >
                {showPassword ? (
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#4A5D23" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                ) : (
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#4A5D23" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg>
                )}
              </span>
            </div>
          ...
          <button type="submit" className="auth-btn" style={{ width: '100%', marginTop: '1.5rem' }}>บันทึกรหัสผ่านใหม่</button>
        </form>
