  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <div style={{
        ...
        <h3 style={{ marginTop: 0, marginBottom: "16px", fontSize: "1.6rem", fontWeight: 600 }}>
          Filters
        </h3>
      ...
      <div style={{
        ...
        {!hasApplied ? (
          <div style={{
            ...
            <h4 style={{ fontSize: "1.3rem", fontWeight: 600, marginBottom: "8px", color: "#666" }}>
              Select your filters
            </h4>
            <p style={{ fontSize: "1.1rem" }}>Choose filter options above and click "Apply Filters" to generate the report.</p>
          </div>
        ) : loading ? (
          <div style={{ textAlign: "center", padding: "60px 20px", color: "#999" }}>
            <div style={{ fontSize: "1.2rem", marginBottom: "16px" }}>Loading report data...</div>
            <div style={{
          ...
          <div style={{
            ...
            <p style={{ fontSize: "1.1rem" }}>No data available for the selected filters.</p>
          </div>
        ) : (
          <div style={{ overflowX: "auto" }}>
            <table style={{
              ...
              <thead>
                <tr style={{ backgroundColor: "#F2EFDB", borderBottom: "1px solid #6d6d6d" }}>
